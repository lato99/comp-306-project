	...
	public StudentsGradesPanel() {
		...
		backButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				KusisFrame.studentsGradesPanel.setVisible(false);		
				
				KusisFrame.instructorPanel = new InstructorPanel(); //take data from database to create this panel.
				KusisFrame.instructorPanel.setVisible(true);
			}
		});
